...
class SqliteMetricStore:
    ...
    def _record_from_row(row: sqlite3.Row) -> MetricStoreRecord:
        ...
        return MetricStoreRecord(
            ...
            current_revenue_cutoff_date=row["current_revenue_cutoff_date"] or "not_applicable",
                ...
                for record in plan.records:
                    ...
                    connection.execute(
                        ...
                        (record.result_id, record.workflow_id, record.workflow_run_id, record.pipeline_id,
                         ...
                         record.workflow_reporting_date, None if record.current_revenue_cutoff_date == "not_applicable" else record.current_revenue_cutoff_date,
