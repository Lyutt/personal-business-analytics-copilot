...
def validate_stage3a_qualification_status_consistency(
    ...
    if not isinstance(stage3c_scope, dict):
        ...
        for file, document, path, expected in (
            ...
            (
                ...
                status_index,
                "current_stage",
                "Stage 3E Weekly Output Assembly and Review Preview Implementation Completed - Exit Qualified; Stage 3F Not Authorized",
            ),
            (
                status_index_path,
                status_index,
    ...
    if not isinstance(stage3e_scope, dict):
        ...
        for file, document, path, expected in (
            ...
            (stage3e_scope_path, stage3e_scope, "owner_decision.implementation_authorized", True),
            (
                stage3e_scope_path,
                stage3e_scope,
            ...
            (stage3e_scope_path, stage3e_scope, "authorization.implementation_authorized", True),
            ...
            (status_index_path, status_index, "current_next_stage_boundary.stage3e_implementation_authorized", True),
            (status_index_path, status_index, "current_next_stage_boundary.stage3e_implementation_started", True),
            (status_index_path, status_index, "current_next_stage_boundary.stage3e_completed", True),
            (
                status_index_path,
                status_index,
    ...
    if not isinstance(stage3d_scope, dict):
        ...
        for file, document, path, expected in (
            ...
            (status_index_path, status_index, "current_next_stage_boundary.stage3e_authorized", True),
